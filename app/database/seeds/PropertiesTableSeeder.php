...
class PropertiesTableSeeder extends Seeder {
  ...
  public function run()
  {
    ...
    Property::create(array(
      ...
      'image_ids' => '1_'.StringHelper::random(10).','.'1_'.StringHelper::random(10).','.'1_'.StringHelper::random(10).','.'1_'.StringHelper::random(10).',',
      ...
      'address_district' => 'Thuận An',
      'address_city' => 'Bình Dương',
